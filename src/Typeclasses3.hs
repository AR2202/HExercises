...
instance Ord Adult2 where
  compare (Adult2 firstname lastname _) (Adult2 firstname2 lastname2 _) = case compare lastname lastname2 of
...
returnHigherInterestRate (p1,i1) (p2,i2)= "'" ++ show p ++ "' has a higher interest rate!"
  where p = if i1>i2 then p1 else p2
